...
class DruckerDashboardStub(object):
  ...
  def __init__(self, channel):
    ...
    self.ServiceInfo = channel.unary_unary(
        '/drucker.DruckerDashboard/ServiceInfo',
        request_serializer=drucker__pb2.ServiceInfoRequest.SerializeToString,
        response_deserializer=drucker__pb2.ServiceInfoResponse.FromString,
        )
    self.UploadModel = channel.stream_unary(
        '/drucker.DruckerDashboard/UploadModel',
        request_serializer=drucker__pb2.UploadModelRequest.SerializeToString,
        response_deserializer=drucker__pb2.ModelResponse.FromString,
        )
    self.SwitchModel = channel.unary_unary(
        '/drucker.DruckerDashboard/SwitchModel',
...
def add_DruckerDashboardServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'ServiceInfo': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=drucker__pb2.ServiceInfoRequest.FromString,
          response_serializer=drucker__pb2.ServiceInfoResponse.SerializeToString,
      ),
      'UploadModel': grpc.stream_unary_rpc_method_handler(
          servicer.UploadModel,
          request_deserializer=drucker__pb2.UploadModelRequest.FromString,
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'drucker.DruckerDashboard', rpc_method_handlers)
  server.add_generic_rpc_handlers((generic_handler,))
...
class DruckerWorkerStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Predict_String_String = channel.unary_unary(
        '/drucker.DruckerWorker/Predict_String_String',
        request_serializer=drucker__pb2.StringInput.SerializeToString,
        response_deserializer=drucker__pb2.StringOutput.FromString,
        )
    self.Predict_String_Bytes = channel.unary_stream(
        '/drucker.DruckerWorker/Predict_String_Bytes',
        request_serializer=drucker__pb2.StringInput.SerializeToString,
        response_deserializer=drucker__pb2.BytesOutput.FromString,
        )
    self.Predict_String_ArrInt = channel.unary_unary(
        '/drucker.DruckerWorker/Predict_String_ArrInt',
        request_serializer=drucker__pb2.StringInput.SerializeToString,
        response_deserializer=drucker__pb2.ArrIntOutput.FromString,
        )
    self.Predict_String_ArrFloat = channel.unary_unary(
        '/drucker.DruckerWorker/Predict_String_ArrFloat',
        request_serializer=drucker__pb2.StringInput.SerializeToString,
        response_deserializer=drucker__pb2.ArrFloatOutput.FromString,
        )
    self.Predict_String_ArrString = channel.unary_unary(
        '/drucker.DruckerWorker/Predict_String_ArrString',
        request_serializer=drucker__pb2.StringInput.SerializeToString,
        response_deserializer=drucker__pb2.ArrStringOutput.FromString,
        )
    self.Predict_Bytes_String = channel.stream_unary(
        '/drucker.DruckerWorker/Predict_Bytes_String',
        request_serializer=drucker__pb2.BytesInput.SerializeToString,
        response_deserializer=drucker__pb2.StringOutput.FromString,
        )
    self.Predict_Bytes_Bytes = channel.stream_stream(
        '/drucker.DruckerWorker/Predict_Bytes_Bytes',
        request_serializer=drucker__pb2.BytesInput.SerializeToString,
        response_deserializer=drucker__pb2.BytesOutput.FromString,
        )
    self.Predict_Bytes_ArrInt = channel.stream_unary(
        '/drucker.DruckerWorker/Predict_Bytes_ArrInt',
        request_serializer=drucker__pb2.BytesInput.SerializeToString,
        response_deserializer=drucker__pb2.ArrIntOutput.FromString,
        )
    self.Predict_Bytes_ArrFloat = channel.stream_unary(
        '/drucker.DruckerWorker/Predict_Bytes_ArrFloat',
        request_serializer=drucker__pb2.BytesInput.SerializeToString,
        response_deserializer=drucker__pb2.ArrFloatOutput.FromString,
        )
    self.Predict_Bytes_ArrString = channel.stream_unary(
        '/drucker.DruckerWorker/Predict_Bytes_ArrString',
        request_serializer=drucker__pb2.BytesInput.SerializeToString,
        response_deserializer=drucker__pb2.ArrStringOutput.FromString,
        )
    self.Predict_ArrInt_String = channel.unary_unary(
        '/drucker.DruckerWorker/Predict_ArrInt_String',
        request_serializer=drucker__pb2.ArrIntInput.SerializeToString,
        response_deserializer=drucker__pb2.StringOutput.FromString,
        )
    self.Predict_ArrInt_Bytes = channel.unary_stream(
        '/drucker.DruckerWorker/Predict_ArrInt_Bytes',
        request_serializer=drucker__pb2.ArrIntInput.SerializeToString,
        response_deserializer=drucker__pb2.BytesOutput.FromString,
        )
    self.Predict_ArrInt_ArrInt = channel.unary_unary(
        '/drucker.DruckerWorker/Predict_ArrInt_ArrInt',
        request_serializer=drucker__pb2.ArrIntInput.SerializeToString,
        response_deserializer=drucker__pb2.ArrIntOutput.FromString,
        )
    self.Predict_ArrInt_ArrFloat = channel.unary_unary(
        '/drucker.DruckerWorker/Predict_ArrInt_ArrFloat',
        request_serializer=drucker__pb2.ArrIntInput.SerializeToString,
        response_deserializer=drucker__pb2.ArrFloatOutput.FromString,
        )
    self.Predict_ArrInt_ArrString = channel.unary_unary(
        '/drucker.DruckerWorker/Predict_ArrInt_ArrString',
        request_serializer=drucker__pb2.ArrIntInput.SerializeToString,
        response_deserializer=drucker__pb2.ArrStringOutput.FromString,
        )
    self.Predict_ArrFloat_String = channel.unary_unary(
        '/drucker.DruckerWorker/Predict_ArrFloat_String',
        request_serializer=drucker__pb2.ArrFloatInput.SerializeToString,
        response_deserializer=drucker__pb2.StringOutput.FromString,
        )
    self.Predict_ArrFloat_Bytes = channel.unary_stream(
        '/drucker.DruckerWorker/Predict_ArrFloat_Bytes',
        request_serializer=drucker__pb2.ArrFloatInput.SerializeToString,
        response_deserializer=drucker__pb2.BytesOutput.FromString,
        )
    self.Predict_ArrFloat_ArrInt = channel.unary_unary(
        '/drucker.DruckerWorker/Predict_ArrFloat_ArrInt',
        request_serializer=drucker__pb2.ArrFloatInput.SerializeToString,
        response_deserializer=drucker__pb2.ArrIntOutput.FromString,
        )
    self.Predict_ArrFloat_ArrFloat = channel.unary_unary(
        '/drucker.DruckerWorker/Predict_ArrFloat_ArrFloat',
        request_serializer=drucker__pb2.ArrFloatInput.SerializeToString,
        response_deserializer=drucker__pb2.ArrFloatOutput.FromString,
        )
    self.Predict_ArrFloat_ArrString = channel.unary_unary(
        '/drucker.DruckerWorker/Predict_ArrFloat_ArrString',
        request_serializer=drucker__pb2.ArrFloatInput.SerializeToString,
        response_deserializer=drucker__pb2.ArrStringOutput.FromString,
        )
    self.Predict_ArrString_String = channel.unary_unary(
        '/drucker.DruckerWorker/Predict_ArrString_String',
        request_serializer=drucker__pb2.ArrStringInput.SerializeToString,
        response_deserializer=drucker__pb2.StringOutput.FromString,
        )
    self.Predict_ArrString_Bytes = channel.unary_stream(
        '/drucker.DruckerWorker/Predict_ArrString_Bytes',
        request_serializer=drucker__pb2.ArrStringInput.SerializeToString,
        response_deserializer=drucker__pb2.BytesOutput.FromString,
        )
    self.Predict_ArrString_ArrInt = channel.unary_unary(
        '/drucker.DruckerWorker/Predict_ArrString_ArrInt',
        request_serializer=drucker__pb2.ArrStringInput.SerializeToString,
        response_deserializer=drucker__pb2.ArrIntOutput.FromString,
        )
    self.Predict_ArrString_ArrFloat = channel.unary_unary(
        '/drucker.DruckerWorker/Predict_ArrString_ArrFloat',
        request_serializer=drucker__pb2.ArrStringInput.SerializeToString,
        response_deserializer=drucker__pb2.ArrFloatOutput.FromString,
        )
    self.Predict_ArrString_ArrString = channel.unary_unary(
        '/drucker.DruckerWorker/Predict_ArrString_ArrString',
        request_serializer=drucker__pb2.ArrStringInput.SerializeToString,
        response_deserializer=drucker__pb2.ArrStringOutput.FromString,
        )
...
def add_DruckerWorkerServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'Predict_ArrInt_String': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=drucker__pb2.ArrIntInput.FromString,
          response_serializer=drucker__pb2.StringOutput.SerializeToString,
      ),
      ...
      'Predict_ArrFloat_String': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=drucker__pb2.ArrFloatInput.FromString,
          response_serializer=drucker__pb2.StringOutput.SerializeToString,
      ),
      ...
      'Predict_ArrString_String': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=drucker__pb2.ArrStringInput.FromString,
          response_serializer=drucker__pb2.StringOutput.SerializeToString,
      ),
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'drucker.DruckerWorker', rpc_method_handlers)
  server.add_generic_rpc_handlers((generic_handler,))
